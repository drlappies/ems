...
function OvertimeHistory() {
  ...
  const fetchOvertime = useCallback(
    async (offset, limit, search, date, employee, status) => {
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API}/api/overtime`,
          {
            params: {
              offset: offset,
              limit: limit,
    ...
    try {
      if (state.selectedRow.length > 1) {
        const res = await axios.delete(
          `${process.env.REACT_APP_API}/api/overtime/${state.selectedRow
    ...
    try {
      if (state.selectedRow.length > 1) {
        const body = {
          ...
          from: state.updateCheckIn
            ? state.updateCheckIn.format("HH:mm:ss")
            : null,
          to: state.updateCheckOut
            ? state.updateCheckOut.format("HH:mm:ss")
            : null,
  ...
  const toggleUpdating = () => {
    setState((prevState) => {
      return { ...prevState, isUpdating: !prevState.isUpdating };
    });
  };
              ...
              <CardContent>
                ...
                <LocalizationProvider dateAdapter={DateAdapter}>
                  <DesktopDatePicker
                    ...
                    onChange={(newValue) => {
                      setState((prevState) => {
                        return { ...prevState, createDate: newValue };
                      });
                    }}
                    renderInput={(params) => (
                      <TextField
                  ...
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setState((prevState) => {
                        return { ...prevState, createCheckIn: newValue };
                      });
                    }}
                    renderInput={(params) => (
                      <TextField
                  ...
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setState((prevState) => {
                        return { ...prevState, createCheckOut: newValue };
                      });
                    }}
                    renderInput={(params) => (
                      <TextField
              ...
              <CardContent>
                <LocalizationProvider dateAdapter={DateAdapter}>
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setState((prevState) => {
                        return { ...prevState, updateCheckIn: newValue };
                      });
                    }}
                    renderInput={(params) => (
                      <TextField
                  ...
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setState((prevState) => {
                        return { ...prevState, updateCheckOut: newValue };
                      });
                    }}
                    renderInput={(params) => (
                      <TextField
